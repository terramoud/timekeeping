...
class SetStopTimeCommandTest {
    ...
    public void setUp() {
        ...
        command = new SetStopTimeCommand(intervalService);
    ...
    /**
     * @see SetStopTimeCommand#execute(HttpServletRequest, HttpServletResponse)
     */
    @Test
    void testExecuteShouldReturnUrl()
            throws ServiceException, CommandException, IntervalException {
        when(intervalService.setFinishTimeForUserActivity(anyLong(), anyLong(), any())).thenReturn(true);
    ...
    void testExecuteShouldReturnUrlAndPutToSessionErrorMessage()
            throws ServiceException, CommandException, IntervalException {
        when(intervalService.setFinishTimeForUserActivity(anyLong(), anyLong(), any())).thenReturn(false);
        assertEquals(req.getHeader("referer"), command.execute(req, resp));
    ...
    void testExecuteShouldReturnUrlAndPutToSessionErrorMessageWhenServiceThrowIntervalException()
            throws ServiceException, CommandException, IntervalException {
        when(intervalService.setFinishTimeForUserActivity(anyLong(), anyLong(), any()))
    ...
    void testExecuteShouldThrowExceptionWhenServiceThrowException()
        ...
        when(intervalService.setFinishTimeForUserActivity(anyLong(), anyLong(), any())).thenThrow(ServiceException.class);
