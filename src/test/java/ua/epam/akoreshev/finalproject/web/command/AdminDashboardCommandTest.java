...
class AdminDashboardCommandTest {
    ...
    private static Stream<Arguments> testCases() {
        return Stream.of(
                ...
                Arguments.of(6, 2, "true", false, "em ail", "em ail", Long.MIN_VALUE+"", 1),
                Arguments.of(7, 2, "true", false, " email", " email", "-1", 1),
                Arguments.of(8, 2, "true", false, "email ", "email ", "100", 100),
                Arguments.of(9, 2, "true", false, " email ", " email ", "100", 100),
                Arguments.of(10, 2, "true", false, "em@ail", "em@ail", "100", 100),
                ...
                Arguments.of(100, 20, "true", false, "їemail", "їemail", "100", 100),
                Arguments.of(100, 20, "true", false, "emailї", "emailї", "100", 100),
