...
class RemoveCategoryCommandTest {
    ...
    public void setUp() {
        ...
        command = new RemoveCategoryCommand(categoryService);
    ...
    /**
     * @see RemoveCategoryCommand#execute(HttpServletRequest, HttpServletResponse)
     */
    @Test
    ...
    void testExecuteShouldThrowExceptionWhenServiceThrowException() throws ServiceException {
        when(categoryService.removeCategory(anyLong())).thenThrow(ServiceException.class);
