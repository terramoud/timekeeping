...
class RemoveAccountCommandTest {
    ...
    public void setUp() {
        ...
        command = new RemoveAccountCommand(userService);
    ...
    /**
     * @see RemoveAccountCommand#execute(HttpServletRequest, HttpServletResponse)
     */
    @Test
    void testExecuteShouldReturnIndexPageUrl()
     ...
     */
    @Test
    void testExecuteShouldReturnRefererAndPutToSessionErrorMessage()
            throws ServiceException, CommandException {
