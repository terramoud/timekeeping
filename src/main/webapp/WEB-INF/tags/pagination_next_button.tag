...
<%@ attribute name="paramsOtherPaginations" type="java.lang.String" required="true" %>

<c:if test="${(pageNum + 1) <= totalPages}">
    <li class="page-item">
        <a class="page-link"
           href="controller?command=admin_dashboard${paramsOtherPaginations}&${paramName}=${pageNum + 1}">
