        ...
        <div class="container-fluid">
            ...
            <div class="row">
                    ...
                    <form class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 text-end control-label col-form-label">Category name en</label>
                                <div class="col-md-9">
                                    <input
                                            type="text"
                                            class="form-control"
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 text-end control-label col-form-label">Category name uk</label>
                                <div class="col-sm-9">
                                    <input
                                            type="text"
                                            class="form-control"
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title mb-0">List all categories</h5>
                            <table class="table">
                                <thead>
                                <tr>
                                    <th scope="col">Category en</th>
                                    <th scope="col">Category uk</th>
                                                    ...
                                                    <div class="modal-body pb-0">
                                                        <div class="card mb-0">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-sm-3 text-end control-label col-form-label">Category
                                                                        name en</label>
                                                                    <div class="col-md-9">
